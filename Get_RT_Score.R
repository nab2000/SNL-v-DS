    ...
    for (i in 1:nrow(movie_df)){
        ...
        if (result_search  == "") {
           ...
           if (length(grep("liked it" , score)) == 0) {next}
            ...
            ## this skips any 
            if (length(result_body[[14]][[3]][[1]]) == 13) {next}
